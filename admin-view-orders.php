...
<?php                                                                                     
	...
	$sql_command = "SELECT order_id, order_date, order_name, order_address, order_phone FROM orders";
...
<html>
	...
	<body>
		...
		style="background:linear-gradient(#800000,#800000);">
			<h2 class="text-center">Member Orders</h2>
				 ...
				 <tr>
					...
					<?php
							...
							while ($row = $db_result->fetch_assoc())
							{
								...
								echo "<tr>";
								echo "<td align=\"center\"><a href=\"admin_order_summary.php?order_id={$row['order_id']}\" class=\"text-warning\">{$row['order_id']}</a></td>";
								echo "<td>{$row['order_name']}</td>";
								echo "<td>{$row['order_address']}</td>";
								echo "<td>{$row['order_phone']}</td>";
								echo "<td>{$row['order_date']}</td>";
								echo "<td align=\"center\"><a href=\"admin_delete_order.php?order_id={$row['order_id']}\" class=\"text-warning\">Delete</a></td>";
								echo "</tr>";
							}
			...
			<?php } else { echo "<h3 class=\"text-center text-warning\" align=\"center\">There are no orders</h3>"; } ?>
