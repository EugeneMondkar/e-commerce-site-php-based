<?php                                                                                     
	...
	*/
	...
	$sql_command = "INSERT INTO products (product_name, product_image, product_description, product_price, product_category)";
	$sql_command .=" VALUES ('{$product_name}', '{$product_image}', '{$product_description}', {$product_price}, '{$product_category}')";
