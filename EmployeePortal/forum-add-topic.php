...
<html>
	...
	<body>
		<div class="container" style="margin-top:30px; background:linear-gradient(#800000,#800000);">
			...
			<h2 class="text-center text-warning">Topic Submission for <?php print($_GET['cat_name']); ?></h2>
			<form action="forum-add-topic-process.php" method="post">
			  
			  <div class="form-group">
			    <label for="topic_subject">Topic Subject:</label>
			    <input type="text" class="form-control" id="topic_subject" name="topic_subject" placeholder="Enter Topic Subject">
			  </div>
