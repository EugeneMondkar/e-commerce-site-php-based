...
<div class="col-sm-8">
	<h1 class="text-warning mb-4 font-bold text-uppercase">Gallo and Sons<br />Company Portal</h1>
</div>
...
<nav class="col-sm-2">
	...
	onclick="location.href = 'logout.php'" >Logout</button>
  	<button type="button" class="btn btn-secondary" 
	onclick="location.href = 'new-password-page.php'">New Password</button>
	</div>
</nav>
