...
<?php                                                                                     
	...
	$sql_command = "SELECT product_id, product_name, product_image, product_description, product_price FROM products WHERE product_category='snack'";
...
<html>
	...
	<body>
		...
		style="background:linear-gradient(#800000,#800000);">
			<h2 class="text-center">Snack Items</h2>
			...
			<table class="table table-dark table-striped">
			 ...
			 <td><a href="admin_modify_item.php?action=<?php echo($row["product_id"]); ?>&back=admin-snacks.php" class="text-warning">Modify</a> / <a href="admin_delete_item.php?action=<?php echo($row["product_id"]); ?>&back=admin-snacks.php" class="text-warning">Delete</a></td>
